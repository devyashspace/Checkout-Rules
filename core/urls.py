...
from .views import install, callback, app_home, create_rule, upgrade, billing_callback, activate_rule, privacy_policy, data_deletion_policy, delete_rule, deactivate_rule
